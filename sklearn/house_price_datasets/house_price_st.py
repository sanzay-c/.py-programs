...
with open(os.path.join(os.path.dirname(__file__),'model_saved/trained_model.pkl'), 'rb') as file:
    loaded_model = pickle.load(file)

with open(os.path.join(os.path.dirname(__file__),'model_saved/scaler.pkl'), 'rb') as file:
